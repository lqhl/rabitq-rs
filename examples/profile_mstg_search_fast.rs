//! Fast profiling benchmark for MSTG search hotspots
//!
//! Usage:
//!   cargo run --release --example profile_mstg_search_fast
...
fn main() {
    println!("\n╔═══════════════════════════════════════════════════════════╗");
    println!("║       MSTG Search Hotspot Analysis (Fast Version)        ║");
    println!("╚═══════════════════════════════════════════════════════════╝\n");

    // Smaller but still representative: 50K vectors, 960 dims (like GIST)
    let n_base = 50_000;
    let dim = 960;
    let n_queries = 100;
    ...
    println!("   cargo flamegraph --example profile_mstg_search_fast\n");
